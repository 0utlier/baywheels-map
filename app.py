...
def create_map(user_coords, classic_count):
    ...
    for station in stations:
        ...
        folium.Marker(
            ...
            popup=folium.Popup(f"{station['black_bikes']}<br>({station['num_ebikes']} e-bikes{classic_bikes_string})<br>{station['black_bikes']} black bikes", max_width=300),
